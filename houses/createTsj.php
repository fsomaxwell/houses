...
$APPLICATION->SetTitle("Создание ТСЖ");
?>
...
<tr>
	...
	<td><input required name="nameTsj" id="nameTsj" type="text" size="34"></td>
</tr> 
</tbody>
</table>
</div>
...
if (isset($_POST['create'])) 
	{
		...
		{ echo "<div id='dialog-message' title='Создание ТСЖ'><p style = 'text-align: center; font-size: 14px; color:red'>ТСЖ успешно создано!</p></div>"; }
		else
